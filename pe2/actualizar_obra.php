<?php           // Recibe los datos del formulario de edición (editar_obra.php), los valida y actualiza la información de la obra en la BD
session_start();
...
// Obtener datos del formulario y el ID de la obra
$id = $_POST['id'];
$titulo = $_POST['titulo'];
$autor = $_POST['autor'];
$fecha = $_POST['fecha'];
...
try {
    ...
    $stmt = $pdo->prepare("UPDATE obras SET titulo = :titulo, autor = :autor, fecha = :fecha, imagen = :imagen, epoca = :epoca, tema = :tema WHERE id = :id");
